...
import github.eddy.java8core.model.SerializableLine;
import github.eddy.java8core.model.SerializablePoint;
 ...
 * @date 2018/1/12
 */
public class CloneableAndSerializableTest {
  ...
  /**
   * 浅拷贝shallow clone
   * 如{@link CloneableAndSerializableTest#cloneTest(), CloneableAndSerializableTest#shallowCloneTest()}所示
  ...
  public void deepCloneTest() throws IOException, ClassNotFoundException {
    ...
    ObjectInputStream in = new ObjectInputStream(new FileInputStream("target/serializableLine.output"));
